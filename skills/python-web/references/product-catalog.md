...
MVP: FastAPI/Jinja2 pages, Tailwind responsive layout, home, services/products, about/trust, gallery, testimonials/review highlights, contact, WhatsApp CTA, address/map, local SEO metadata.
...
Optional: HTMX form partials, CRM/Zapier/Make webhook, lead storage, analytics events.
